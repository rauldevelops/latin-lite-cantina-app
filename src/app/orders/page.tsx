    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-4xl mx-auto px-4">
        <div className="flex justify-between items-center mb-8">
          ...
          <Link
            href="/order"
            className="px-4 py-2 bg-latin-red text-white text-sm font-semibold rounded-full hover:bg-latin-orange uppercase transition-colors"
          >
            Place New Order
          </Link>
        </div>
                ...
                <div className="p-6">
                  <div className="flex flex-wrap justify-between items-start gap-4 mb-4">
                    <div>
                      ...
                      <p className="text-sm font-medium text-latin-red mt-1">
                  ...
                  <div className="mt-4 pt-4 border-t border-gray-100 flex justify-end">
                    <span className="text-sm text-latin-red font-medium transition-colors">
                      View Details →
                    </span>
                  </div>
                </div>
