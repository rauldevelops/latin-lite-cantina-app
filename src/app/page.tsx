    ...
    <div className="min-h-screen bg-gradient-to-b from-green-50 to-white">
      ...
      <section className="max-w-6xl mx-auto px-4 py-16 sm:py-24">
        <div className="text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link
              href="/order"
              className="px-8 py-3 bg-white text-green-600 font-medium rounded-lg border-2 border-green-600 hover:bg-green-50 transition-colors"
            >
              Start Your Order
            </Link>
          </div>
        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="max-w-md mx-auto bg-white rounded-2xl shadow-lg overflow-hidden">
            <div className="bg-green-600 text-white p-6 text-center">
              ...
              <p className="text-green-100">1 Entree + 3 Sides</p>
            </div>
      ...
      <footer className="bg-gray-900 text-white py-8">
        <div className="max-w-6xl mx-auto px-4 text-center">
          <p className="text-xl font-bold text-green-400 mb-2">Latin Lite Cantina</p>
